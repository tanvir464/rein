...
export const metadata: Metadata = {
  title: 'Investor Deck — REIN',
  description: 'REIN: On-chain spending policies for AI agents. Seed round pitch deck.',
};
  ...
  return (
    <header style={{
      ...
      <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 8, textDecoration: 'none' }}>
        ...
        <span style={{ marginLeft: 6, fontSize: 11, fontWeight: 600, color: 'rgba(255,255,255,0.35)', letterSpacing: '0.06em', textTransform: 'uppercase' }}>Investor Deck</span>
      </Link>
      ...
      <section style={{
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 24, justifyContent: 'center' }}>
          {[
            ...
            { label: 'Docs', href: 'https://docs.rein.so', external: true },
